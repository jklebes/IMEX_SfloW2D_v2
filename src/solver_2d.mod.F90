...
#line 1 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!********************************************************************************
...
CONTAINS
  ...
  SUBROUTINE allocate_solver_variables
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 246 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    REAL(wp) :: gamma , delta
  ...
  SUBROUTINE deallocate_solver_variables
      ...
      include 'solver_2d.f90.opari.inc'
#line 507 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE check_solve(solve_all)
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 611 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    INTEGER :: i,j,k
      ...
      opari2_ctc_1 )
#line 615 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp parallel &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_1)
#line 616 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
         
    IF ( solve_all ) THEN

      call POMP2_Workshare_enter(opari2_region_2, &
     opari2_ctc_2 )
#line 619 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp workshare
       solve_mask(2:comp_cells_x-1,2:comp_cells_y-1) = .TRUE. 
#line 621 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end workshare nowait
      call POMP2_Implicit_barrier_enter(opari2_region_2,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_2, pomp2_old_task)
      call POMP2_Workshare_exit(opari2_region_2)
#line 622 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    ELSE
       
      call POMP2_Workshare_enter(opari2_region_3, &
     opari2_ctc_3 )
#line 625 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp workshare
       solve_mask(2:comp_cells_x-1,2:comp_cells_y-1) = .FALSE.
#line 627 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end workshare nowait
...
#line 628 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    END IF
      call POMP2_Barrier_enter(opari2_region_4,&
      pomp2_old_task, opari2_ctc_4 )
#line 630 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp barrier
      call POMP2_Barrier_exit(opari2_region_4, pomp2_old_task)
#line 631 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    
      call POMP2_Workshare_enter(opari2_region_5, &
     opari2_ctc_5 )
#line 632 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp workshare
    WHERE ( ( q(1,2:comp_cells_x-1,2:comp_cells_y-1) .GT. 0.0_wp ) .AND.        &
         ( solve_mask_time(2:comp_cells_x-1,2:comp_cells_y-1) .LE. t ) )       & 
         solve_mask(2:comp_cells_x-1,2:comp_cells_y-1) = .TRUE.
#line 636 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end workshare nowait
...
#line 637 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    
      call POMP2_Barrier_enter(opari2_region_6,&
      pomp2_old_task, opari2_ctc_6 )
#line 638 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp barrier
      call POMP2_Barrier_exit(opari2_region_6, pomp2_old_task)
#line 639 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    IF ( bottom_radial_source_flag ) THEN

      call POMP2_Workshare_enter(opari2_region_7, &
     opari2_ctc_7 )
#line 642 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp workshare
       WHERE ( cell_source_fractions .GT. 0.0_wp ) solve_mask = .TRUE.
#line 644 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end workshare nowait
      call POMP2_Implicit_barrier_enter(opari2_region_7,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_7, pomp2_old_task)
      call POMP2_Workshare_exit(opari2_region_7)
#line 645 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       
      call POMP2_Barrier_enter(opari2_region_8,&
      pomp2_old_task, opari2_ctc_8 )
#line 646 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp barrier
      call POMP2_Barrier_exit(opari2_region_8, pomp2_old_task)
#line 647 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    END IF

    IF ( radial_source_flag ) THEN
             
      call POMP2_Do_enter(opari2_region_9, &
     opari2_ctc_9 )
#line 652 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp do private(j,k)
...
#line 668 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_9,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_9, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_9)
#line 669 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    END IF

      call POMP2_Barrier_enter(opari2_region_10,&
      pomp2_old_task, opari2_ctc_10 )
#line 672 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp barrier
      call POMP2_Barrier_exit(opari2_region_10, pomp2_old_task)
#line 673 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
#line 673 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp master
      call POMP2_Master_begin(opari2_region_11, &
     opari2_ctc_11 )
#line 674 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    END DO
      ...
      call POMP2_Master_end(opari2_region_11)
#line 698 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end master
      call POMP2_Barrier_enter(opari2_region_12,&
      pomp2_old_task, opari2_ctc_12 )
#line 699 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp barrier
      call POMP2_Barrier_exit(opari2_region_12, pomp2_old_task)
#line 700 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

      call POMP2_Do_enter(opari2_region_13, &
     opari2_ctc_13 )
#line 701 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp do private(j,k)
...
#line 717 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end do nowait
...
#line 718 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
      call POMP2_Workshare_enter(opari2_region_14, &
     opari2_ctc_14 )
#line 718 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp workshare
...
#line 723 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end workshare nowait
      call POMP2_Implicit_barrier_enter(opari2_region_14,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_14, pomp2_old_task)
      call POMP2_Workshare_exit(opari2_region_14)
#line 724 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
#line 725 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end parallel
      call POMP2_Parallel_join(opari2_region_1, pomp2_old_task)
#line 726 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE timestep
    ...
    IMPLICIT none
      ...
      include 'solver_2d.f90.opari.inc'
#line 823 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    IF ( cfl .NE. -1.0_wp ) THEN
      ...
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_15 )
#line 836 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
#line 856 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end do nowait
...
#line 857 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
      ...
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_16 )
#line 867 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp parallel &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_16)
#line 868 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
      call POMP2_Do_enter(opari2_region_17, &
     opari2_ctc_17 )
#line 868 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       ...
       END DO
#line 882 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Do_exit(opari2_region_17)
#line 883 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    
      call POMP2_Do_enter(opari2_region_18, &
     opari2_ctc_18 )
#line 884 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp do private(j,k,i)
       ...
       END DO
#line 899 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_18,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_18, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_18)
#line 900 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

      call POMP2_Do_enter(opari2_region_19, &
     opari2_ctc_19 )
#line 901 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
     ...
     opari2_ctc_20 )
#line 935 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
          !$omp atomic
          dt = MIN(dt,dt_cfl)
      call POMP2_Atomic_exit(opari2_region_20)
#line 937 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
          !$omp end atomic

       END DO
#line 940 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_19,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_19, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_19)
#line 941 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
#line 942 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
!!$    USE parameters_2d, ONLY : time_param , bottom_radial_source_flag
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 982 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    IF ( verbose_level .GE. 1 ) WRITE(*,*) 'solver, imex_RK_solver: beginning'
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_21,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_21 )
#line 991 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp parallel &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_21)
#line 992 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
 
      call POMP2_Do_enter(opari2_region_22, &
     opari2_ctc_22 )
#line 993 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp do private(j,k)
    DO l = 1,solve_cells
    ...
    END DO
#line 1020 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_22,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_22, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_22)
#line 1021 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

      call POMP2_Implicit_barrier_enter(opari2_region_21,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_21, pomp2_old_task)
      call POMP2_Parallel_end(opari2_region_21)
#line 1022 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end parallel
      call POMP2_Parallel_join(opari2_region_21, pomp2_old_task)
#line 1023 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    runge_kutta:DO i_RK = 1,n_RK
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_23,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_23 )
#line 1039 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp parallel  &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_23)
#line 1040 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
      call POMP2_Do_enter(opari2_region_24, &
     opari2_ctc_24 )
#line 1040 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
#line 1257 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_24,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_24, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_24)
#line 1258 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
      call POMP2_Implicit_barrier_enter(opari2_region_23,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_23, pomp2_old_task)
      call POMP2_Parallel_end(opari2_region_23)
#line 1258 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end parallel 
      call POMP2_Parallel_join(opari2_region_23, pomp2_old_task)
#line 1259 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    END DO runge_kutta
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_25,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_25 )
#line 1272 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp parallel    private(j,k) &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_25)
      call POMP2_Do_enter(opari2_region_25, &
     opari2_ctc_25 )
#line 1272 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp          do             
...
#line 1459 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_25,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_25, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_25)
      call POMP2_Parallel_end(opari2_region_25)
#line 1459 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end parallel
      call POMP2_Parallel_join(opari2_region_25, pomp2_old_task)
#line 1460 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE solve_rk_step( qj, qj_old, a_tilde, a_dirk, a_diag, Rj_not_impl,   &
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 1502 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE lnsrch( qj_rel_NR_old , qj_org , qj_old , scal_f_old , grad_f ,    &
    ...
    !> Initial point
      include 'solver_2d.f90.opari.inc'
#line 1855 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE eval_f( qj , qj_old , a_diag , coeff_f , Rj_not_impl , Bprimej_x , &
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 2076 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE eval_jacobian( qj_rel , qj_org , coeff_f, Bprimej_x , Bprimej_y ,  &
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 2130 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE update_erosion_deposition_cell(dt)
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 2216 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    IF ( ( erosion_coeff .EQ. 0.0_wp ) .AND. ( .NOT.settling_flag ) ) RETURN
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_26,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_26 )
#line 2244 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp parallel    private(j,k,erosion_term,deposition_term,eqns_term,       &
    !$omp & topo_term,r_ri,r_rho_m,r_rho_c,r_red_grav,                          &
    !$omp & continuous_phase_erosion_term,continuous_phase_loss_term) &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_26)
      call POMP2_Do_enter(opari2_region_26, &
     opari2_ctc_26 )
#line 2244 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp          do                                                            
...
#line 2408 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_26,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_26, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_26)
      call POMP2_Parallel_end(opari2_region_26)
#line 2408 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end parallel
      call POMP2_Parallel_join(opari2_region_26, pomp2_old_task)
#line 2409 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE eval_hyperbolic_terms( q_expl , qp_expl , divFlux_iRK )
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 2438 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    END SELECT
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_27,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_27 )
#line 2475 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp parallel    private(l,j,k,i) &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_27)
      call POMP2_Do_enter(opari2_region_27, &
     opari2_ctc_27 )
#line 2475 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp          do                 
...
#line 2504 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_27,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_27, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_27)
      call POMP2_Parallel_end(opari2_region_27)
#line 2504 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end parallel
      call POMP2_Parallel_join(opari2_region_27, pomp2_old_task)
#line 2505 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE eval_flux_UP
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 2528 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    IF ( comp_cells_x .GT. 1 ) THEN
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_28,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_28 )
#line 2540 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp parallel    private(l,j,k,fluxl,fluxr) &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_28)
      call POMP2_Do_enter(opari2_region_28, &
     opari2_ctc_28 )
#line 2540 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp          do                           
...
#line 2581 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_28,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_28, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_28)
      call POMP2_Parallel_end(opari2_region_28)
#line 2581 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end parallel
      call POMP2_Parallel_join(opari2_region_28, pomp2_old_task)
#line 2582 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    IF ( comp_cells_y .GT. 1 ) THEN
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_29,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_29 )
#line 2588 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp parallel    private(l,j,k,fluxb,fluxt) &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_29)
      call POMP2_Do_enter(opari2_region_29, &
     opari2_ctc_29 )
#line 2588 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp          do                           
...
#line 2631 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_29,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_29, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_29)
      call POMP2_Parallel_end(opari2_region_29)
#line 2631 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end parallel
      call POMP2_Parallel_join(opari2_region_29, pomp2_old_task)
#line 2632 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE eval_flux_KT
    ...
    IMPLICIT NONE
      ...
      include 'solver_2d.f90.opari.inc'
#line 2658 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    REAL(wp) :: fluxL(n_eqns)           !< Numerical fluxes from the eqns 
    REAL(wp) :: fluxR(n_eqns)           !< Numerical fluxes from the eqns
    REAL(wp) :: fluxB(n_eqns)           !< Numerical fluxes from the eqns 
    REAL(wp) :: fluxT(n_eqns)           !< Numerical fluxes from the eqns
    ...
    !H_interface_y = 0.0_wp
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_30,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_30 )
#line 2674 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp parallel &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_30)
#line 2675 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    IF ( comp_cells_x .GT. 1 ) THEN

      call POMP2_Do_enter(opari2_region_31, &
     opari2_ctc_31 )
#line 2678 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
#line 2729 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Do_exit(opari2_region_31)
#line 2730 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    ...
    IF ( comp_cells_y .GT. 1 ) THEN
      ...
      call POMP2_Do_enter(opari2_region_32, &
     opari2_ctc_32 )
#line 2737 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
#line 2788 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_32,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_32, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_32)
#line 2789 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    END IF

      call POMP2_Implicit_barrier_enter(opari2_region_30,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_30, pomp2_old_task)
      call POMP2_Parallel_end(opari2_region_30)
#line 2792 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end parallel
      call POMP2_Parallel_join(opari2_region_30, pomp2_old_task)
#line 2793 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE reconstruction(q_expl,qp_expl)
    ...
    !WRITE(*,*) 'qp_expl(:,1,1)',qp_expl(:,1,1)
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_33,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_33 )
#line 2941 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp parallel    private(j,k,i,qrecw,qrece,qrecs,qrecn,x_stencil,y_stencil,&
    !$omp & qrec_stencil,qrec_prime_x,qrec_prime_y,qp2recw,qp2rece,qp2recs,     &
    !$omp & qp2recn,source_bdry,dq) &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_33)
      call POMP2_Do_enter(opari2_region_33, &
     opari2_ctc_33 )
#line 2941 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp          do                                                            
...
#line 3673 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_33,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_33, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_33)
      call POMP2_Parallel_end(opari2_region_33)
#line 3673 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
!$omp end parallel
      call POMP2_Parallel_join(opari2_region_33, pomp2_old_task)
#line 3674 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
  ...
  SUBROUTINE eval_speeds
    ...
    INTEGER :: j,k,l
      ...
      pomp2_num_threads = pomp2_lib_get_max_threads()
      pomp2_if = .true.
      call POMP2_Parallel_fork(opari2_region_34,&
      pomp2_if, pomp2_num_threads, pomp2_old_task, &
      opari2_ctc_34 )
#line 3705 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp parallel &
  !$omp firstprivate(pomp2_old_task) private(pomp2_new_task) &
  !$omp num_threads(pomp2_num_threads)
      call POMP2_Parallel_begin(opari2_region_34)
#line 3706 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    IF ( comp_cells_x .GT. 1 ) THEN

      call POMP2_Do_enter(opari2_region_35, &
     opari2_ctc_35 )
#line 3709 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
#line 3731 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Do_exit(opari2_region_35)
#line 3732 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    END IF

    IF ( comp_cells_y .GT. 1 ) THEN

      call POMP2_Do_enter(opari2_region_36, &
     opari2_ctc_36 )
#line 3737 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
#line 3759 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
       !$omp end do nowait
      call POMP2_Implicit_barrier_enter(opari2_region_36,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_36, pomp2_old_task)
      call POMP2_Do_exit(opari2_region_36)
#line 3760 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"

    END IF

      call POMP2_Implicit_barrier_enter(opari2_region_34,&
      pomp2_old_task)
!$omp barrier
      call POMP2_Implicit_barrier_exit(opari2_region_34, pomp2_old_task)
      call POMP2_Parallel_end(opari2_region_34)
#line 3763 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
    !$omp end parallel
      call POMP2_Parallel_join(opari2_region_34, pomp2_old_task)
#line 3764 "/home/jklebes/geoboost/IMEX_SfloW2D_v2/src/solver_2d.f90"
...
END MODULE solver_2d
      ...
      subroutine POMP2_Init_reg_qzzm3qw7micl8_36()
         include 'solver_2d.f90.opari.inc'
         ...
         opari2_ctc_23 )
         call POMP2_Assign_handle( opari2_region_24, &
         opari2_ctc_24 )
         call POMP2_Assign_handle( opari2_region_25, &
         opari2_ctc_25 )
         call POMP2_Assign_handle( opari2_region_26, &
         opari2_ctc_26 )
         call POMP2_Assign_handle( opari2_region_27, &
         opari2_ctc_27 )
         call POMP2_Assign_handle( opari2_region_28, &
         opari2_ctc_28 )
         call POMP2_Assign_handle( opari2_region_29, &
         opari2_ctc_29 )
         call POMP2_Assign_handle( opari2_region_30, &
         opari2_ctc_30 )
         call POMP2_Assign_handle( opari2_region_31, &
         opari2_ctc_31 )
         call POMP2_Assign_handle( opari2_region_32, &
         opari2_ctc_32 )
         call POMP2_Assign_handle( opari2_region_33, &
         opari2_ctc_33 )
         call POMP2_Assign_handle( opari2_region_34, &
         opari2_ctc_34 )
         call POMP2_Assign_handle( opari2_region_35, &
         opari2_ctc_35 )
         call POMP2_Assign_handle( opari2_region_36, &
         opari2_ctc_36 )
      end
